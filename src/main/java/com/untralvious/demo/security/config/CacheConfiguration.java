...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.untralvious.demo.security.domain.SysUser.class.getName(), jcacheConfiguration);
            createCache(cm, com.untralvious.demo.security.domain.SysUser.class.getName() + ".ids", jcacheConfiguration);
            createCache(cm, com.untralvious.demo.security.domain.SysRole.class.getName(), jcacheConfiguration);
            createCache(cm, com.untralvious.demo.security.domain.SysRole.class.getName() + ".ids", jcacheConfiguration);
